...
const profiles: Record<string, BoothProfile> = {
  'iran-paper-modern': {
    ...
    surfaces: { floor: 'bazaar-floor', wall: 'bazaar-plaster', wood: 'bazaar-plywood', counter: 'bazaar-plywood', metal: 'metal-charcoal' },
  ...
  'kaghazforoush-stockroom': {
    ...
    surfaces: { floor: 'bazaar-floor', wall: 'bazaar-plaster', wood: 'wood-walnut', counter: 'bazaar-plywood', metal: 'metal-charcoal' },
  ...
  'seraj-heritage': {
    ...
    surfaces: { floor: 'bazaar-floor', wall: 'bazaar-brick', wood: 'wood-walnut', counter: 'bazaar-plywood', metal: 'metal-brass' },
